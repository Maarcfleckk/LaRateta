...
var audio = new Audio("./audio/conte-la-rateta-que-escombrava-lescaleta-ingles.wav");
var isPlaying = false;
...
function toggleAudio() {
  if (isPlaying) {
    ...
    document.getElementById("topBarHeading").innerText = "START AUDIO";
  } else {
    audio.play();
    document.getElementById("playPauseIcon").src = "./images/pausa.png";
    document.getElementById("topBarHeading").innerText = "RESET AUDIO";
  }
  isPlaying = !isPlaying;
}
