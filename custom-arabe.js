...
var audio = new Audio("./audio/conte-la-rateta-que-escombrava-lescaleta-arabe.wav");
var isPlaying = false;
...
function toggleAudio() {
  if (isPlaying) {
    ...
    document.getElementById("topBarHeading").innerText = "دء الصبوت";
  } else {
    audio.play();
    document.getElementById("playPauseIcon").src = "./images/pausa.png";
    document.getElementById("topBarHeading").innerText = "وقفة الصوت";
  }
  isPlaying = !isPlaying;
}
